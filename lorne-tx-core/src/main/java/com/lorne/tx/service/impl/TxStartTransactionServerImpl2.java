 ...
 */
@Service(value = "txStartTransactionServer2")
public class TxStartTransactionServerImpl2 implements TransactionServer {


    private Logger logger = LoggerFactory.getLogger(TxStartTransactionServerImpl2.class);
